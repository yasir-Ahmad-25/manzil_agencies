...
<?= $this->section('content');?>
    ...
    <!-- add modal -->
    <div id="branch_modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" data-bs-backdrop='static' data-bs-keyboard='false'>
        <div class="modal-dialog ">
            <div class="modal-content">
                <div class="modal-header d-flex align-items-center">
                    <h4 class="modal-title" id="myModalLabel"><?= 'Manage Branches' ?></h4>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group text-dark">
                                    ...
                                    <input type="text" class="form-control border-secondary" name="br_name" id="br_name" required>
                                    <input type="hidden" name="btn_action" id="btn_action">
                                    <input type="hidden" name="br_id" id="br_id">
                                </div>
                                <div class="form-group text-dark">
                                    <label><?= 'Location'  ?></label>
                                    <input type="text" class="form-control border-secondary" name="br_address" id="br_address" required>
