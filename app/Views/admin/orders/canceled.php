...
<div class="page-wrapper">
    ...
    <script type="text/javascript">
        ...
        function get_orders_list(wid, date) {
            ...
            $.ajax({
                type: 'POST',
                url: base_url+ '/orders/get_canceled_orders',
                data: {
                    date: date,
                    wid: wid
                },
        ...
        function process_recover(basket_id, amount) {

            if (amount == undefined) {
                alert('Lama soo celin karo dalabkaan');
                return;
            }

            if (confirm('Ma hubtaa inaad soo celiso dalab-kaan?')) {

                $.ajax({
                    type: 'POST',
                    url: '<?= base_url() ?>order/recover_order',
                    data: {
                        basket_id: basket_id,
