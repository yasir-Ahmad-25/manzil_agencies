      ...
      <div class="container-fluid">
                  ...
                  <div class="card">
                      ...
                      <div class="card-body">
                          ...
                          <div class="row">
                              ...
                              <div class="col-12" id="display_balance_sheet">
                              </div>
                  ...
                  <form id="print_form">
                      <div class="modal-content" id="change_state">
                          ...
                          <div class="modal-body" id="print_area">
                              ...
                              <div class="row col-12" id="dispaly_balance_sheet_modal" style="margin: 10px;">
          ...
          <script type="text/javascript">
              ...
              $(document).ready(function() {
                  ...
                  print_balane_sheet(first_date, to_day);
              });
              ...
              $('#search_btn').on('click', function() {
                  ...
                  print_balane_sheet(from_date, to_date)
              });
              ...
              function print_balane_sheet(from_date, to_date) {

                  $('#search_btn').attr('disabled', true)

                  $.ajax({
                      url: base_url + '/report/print_balance_sheet',
                      type: "POST",
                      data: {
                          from_date: from_date,
                          to_date: to_date,
                      ...
                      success: function(response) {
                          ...
                          $("#display_balance_sheet").html(response);
                          $("#dispaly_balance_sheet_modal").html(response);
