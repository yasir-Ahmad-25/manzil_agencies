        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header d-flex align-items-center">
                    <h4 class="modal-title" id="myModalLabel">Deposit Payment</h4>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        manageTable = $('#manageTable').DataTable({
            'ajax': base_url + '/customer/fetch_deposits',
            'order': []
        });
        ...
        $('#sup_id').on('change', function() {
            ...
            $.ajax({
                url: base_url + '/customer/get_outstanding_deposits',
                type: "POST",
                data: {
                    sup_id: $(this).val(),
                },
        ...
        $(document).on('submit', '#data_form', function(event) {
            form(new FormData(this), '/customer/create_deposit_payment', '#data_form', '#payment_modal', '#inner_add');
        });
