                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group text-dark">
                                            ...
                                            <input type="hidden" name="service_id" id="rate_id">

                                            <label>Service Name</label>
                                            <input type="text" class="form-control border-secondary" name="service_name" id="base_name">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group text-dark">
                                            <label>Price</label>
                                            <input type="text" class="form-control border-secondary" name="price" id="rate_percentage">
                                        </div>
                                    </div>
    ...
    $(document).ready(function() {
        ...
        function meal() {
            ...
            manageTable = $('#manageTable').DataTable({
                'ajax': base_url + '/reading/fetch_services',
                'order': [],
                destroy: true,
                searching: false
            });
        ...
        $(document).on('submit', '#data_form', function(event) {
            form(new FormData(this), '/reading/crud_services', '#data_form', '#rate_modal', '#inner_add');
        });
