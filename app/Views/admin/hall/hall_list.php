        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <button class="btn btn-primary" id="btn_add" data-bs-toggle="modal" data-bs-target="#hall_modal">
                        <?= 'Add Hall' ?>
                    </button> <br> <br>
...
<!-- form modal -->
<div id="hall_modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" data-bs-backdrop='static' data-bs-keyboard='false'>
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header d-flex align-items-center">
                <h4 class="modal-title" id="myModalLabel"><?= 'Halls' ?></h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group text-dark">
                                        ...
                                        <input type="text" class="form-control border-secondary" name="hall_name" id="hall_name">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group text-dark">
                                        ...
                                        <input type="number" class="form-control border-secondary" name="hall_price" id="hall_price">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group text-dark">
                                        ...
                                        <input type="number" class="form-control border-secondary" name="hall_cap" id="hall_cap">
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        //-- Details --\\ 
        $('#hall_modal').on('show.bs.modal', function(e) {
            ...
            if (event.target.id == 'btn_add') {
                ...
                $('#hall_name').val($(e.relatedTarget).data('hall_name'));
                $('#hall_cap').val($(e.relatedTarget).data('hall_min'));
                $('#hall_price').val($(e.relatedTarget).data('hall_price'));
                $('#hall_des').val($(e.relatedTarget).data('hall_des'));
        ...
        $(document).on('submit', '#data_form', function(event) {
            form(new FormData(this), '/hall/create_hall', '#data_form', '#hall_modal', '#inner_add');
        });
    ...
    function state_change(rec_page, rec_tbl, rec_tag, rec_tag_col, rec_id, rec_id_col, rec_title) {
        // alert('')
        $.ajax({
            url: base_url + 'hall/change_status',
            type: "POST",
            dataType: 'json',
            data: {
                rec_id: rec_id,
